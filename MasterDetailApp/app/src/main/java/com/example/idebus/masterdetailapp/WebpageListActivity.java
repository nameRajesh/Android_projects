package com.example.idebus.masterdetailapp;
...
import com.example.idebus.masterdetailapp.dummy.DummyContent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "This function is not available now.", Snackbar.LENGTH_LONG)
